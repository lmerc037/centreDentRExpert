                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="login" action="" method="post" onsubmit="return loginValidation()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-user" type="text" name="username" id="username">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-user" type="password" name="login-password" id="login-password">
                                        </div>


                                        <div class="form-group">
                                            <input class="btn btn-primary btn-user btn-block" type="submit" name="login-btn" id="login-btn" value="Connexion">
                                        </div>
                                    </form>
