						...
						while($row = $result->fetch_assoc()) { ?>
							...
							<div class="card shadow mb-4">
								...
								<div class="row">
 									 ...
 									 <div class="col-4"> <?php echo '<a href="editemploye.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip" style="float:right"><i class="fas fa-edit"></i></span></a>';?></div>
								</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<select class="form-select" aria-label="Choisir un role" name="role" id="role"  disabled >
														<option selected disabled>Pas de role</option>
											...
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<select class="form-select" aria-label="Choisir un type" name="type" id="type"   disabled >
														<option selected disabled>Pas de type</option>
