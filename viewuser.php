						...
						while($row = $result->fetch_assoc()) { ?>
							...
							<div class="card shadow mb-4">
								...
								<div class="col-6"><h6 class="m-0 font-weight-bold text-primary">Profil de l'utilisateur: <?php  echo $row["prenom"] ?>	<?php  echo $row["nom"] ?></h6></div>
									  <div class="col-3"> <?php echo '<a href="adduseremploye.php?id='. $row['id'] .'" class="btn btn-primary btn-user btn-block" title="Update Record" data-toggle="tooltip" style="float:right">Ajouter comme employé</span></a>';?>
						</div> <div class="col-3"><?php echo '<a href="adduserclient.php?id='. $row['id'] .'" class="btn btn-secondary btn-user btn-block" title="Update Record" data-toggle="tooltip" style="float:right">Ajouter comme client</span></a>';?>
